...
export const metadata = { title: `${TRANSFER_CONFIG["pallet"].title} · PMAI Warehouse` };

export default async function Page() {
  await requirePermission("wh.transfer.view");
  const cfg = TRANSFER_CONFIG["pallet"];
  ...
  return (
    <>
      ...
      <TransferClient kind="pallet" unit={cfg.unit} slots={slots} />
    </>
  );
}
