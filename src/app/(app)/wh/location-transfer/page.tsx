...
export const metadata = { title: `${TRANSFER_CONFIG["location"].title} · PMAI Warehouse` };

export default async function Page() {
  await requirePermission("wh.transfer.view");
  const cfg = TRANSFER_CONFIG["location"];
  ...
  return (
    <>
      ...
      <TransferClient kind="location" unit={cfg.unit} slots={slots} />
    </>
  );
}
